...
//table header        
    ...
    $this->SetTitle('RESUMEN DE DENUNCIAS RECIBIDAS');
...
while($i<$numregs)
{
    ...
    $nombre=pg_result($consulta,$i,'den_nombre');
    $ci=pg_result($consulta,$i,'den_ci');
    $telefono=pg_result($consulta,$i,'den_telef');
  ...
  /*
   ...
   $this->Cell(25,10,'Item',1,0,'C',1);
    ...
    $pdf->Cell(15,5,$telefono,1,1,'C',$fill);
