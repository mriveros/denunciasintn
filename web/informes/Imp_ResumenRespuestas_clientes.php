...
//table header        
    ...
    $this->Cell(300,5,'DENUNCIAS CIUDADANAS',100,100,'C');//Titulo
     $this->Cell(300,10,'RESUMEN DE RESPUESTAS EMITIDAS A FAVOR DE CLIENTES',100,100,'C');//Titulo
...
$consulta=pg_exec($conectate,"SELECT den.den_cod,den.den_motivo,den.den_fecha,den.den_obs,den.den_empresa,den.den_direccion,den.den_fecha,res.res_obs,res.res_fecha
                    ...
                    where res.den_cod=den.den_cod and res.res_fecha >= '$fechadesde' and res.res_fecha<='$fechahasta'  and res_veredicto='Cliente' order by res_fecha ");
