...
<head>
    ...
    <meta name="author" content="">
     ...
     <title>INTN Denuncias-Resumen Denuncias</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Resumen de Denuncias Recibidas
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="Imp_ResumenDenuncias.php" method="post" role="form">
