...
<head>
    ...
    <meta name="author" content="">
     ...
     <title>INTN Denuncias-Resumen Denuncias Atendidas</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Informes - <small>Denuncias INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Resumen de Denuncias Atendidas
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="Imp_ResumenDenunciasAtendidas.php" method="post" role="form">
