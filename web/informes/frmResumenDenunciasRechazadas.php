...
<head>
    ...
    <meta name="author" content="">
     ...
     <title>INTN Denuncias-Denuncias Rechazadas</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Resumen de Denuncias Rechazadas
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="Imp_ResumenDenunciasRechazadas.php" method="post" role="form">
