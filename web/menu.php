<?php
    ...
    $conectate=pg_connect("host=54.94.199.60 port=5432 dbname=denunciasintn user=postgres password=2016aws.Postgres.ubuntu")or die ('Error al conectar a la base de datos');
