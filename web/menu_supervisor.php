...
if(!isset($_SESSION['codigo_usuario']))
    ...
    if($catego==2){
        header("Location:http://104.236.113.194/denunciasintn/web/menu_usuario.php");
    }
    if($catego==3){
        header("Location:http://104.236.113.194/denunciasintn/web/menu_supervisor.php");
    }
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="http://104.236.113.194/denunciasintn/web/logout.php"><i class="fa fa-sign-out fa-fw"></i> Cerrar Sesion</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/FrmRegistrosFecha.php">Resumen Registros por mes</a>
                                </li>
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/frmClientesFecha.php">Resumen Registros por Cliente-Fecha</a>
                                </li>
                                 <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/frmDistribuidorFecha.php">Resumen Registros por Distribuidor</a>
                                </li>
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/FrmDepartamentoFecha.php">Resumen por Departamentos-Fecha</a>
                                </li>
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/FrmUsuariosFecha.php">Resumen por Usuarios-Fecha</a>
                                </li>
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/frmRankingRegistrosFecha.php">Ranking Registros por mes</a>
                                </li>
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/frmRankingClientesFecha.php">Ranking Registros por Clientes</a>
                                </li>
                                 <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/informes/frmRankingDepartamentoFecha.php">Ranking Registros por Departamento</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
