<?php 
    $conectate=pg_connect("host=104.236.113.194 port=5432 dbname=denunciasintn user=postgres password=postgres")or die ('Error al conectar a la base de datos');
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <img src="http://104.236.113.194/denunciasintn/img/gama_fiesta.png" width=500 height=80 alt="Obra de K. Haring"> 
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="http://104.236.113.194/web/logout.php"><i class="fa fa-sign-out fa-fw"></i> Cerrar Sesion</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="http://104.236.113.194/denunciasintn/web/menu_usuario.php" value="Load new document" onclick="location.reload();"><i class="fa  fa-tasks"></i> Menu Principal</a>
                        </li>
			<li>
                            <a href="#"><i class="fa  fa-users"></i> RESERVAS<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/reservas/ABMreserva.php"> Registros de Reservas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/eventos/ABMevento.php">Registros de Eventos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/galerias/ABMgaleria.php">Registros de Imágenes</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://104.236.113.194/denunciasintn/web/productos/ABMproducto.php">Registros Productos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
